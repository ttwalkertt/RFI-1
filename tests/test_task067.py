...
class Task067Case(unittest.TestCase):
    ...
    def test_unchanged_reordering_material_update_and_duplicate_content(self) -> None:
        ...
        self.assertEqual(first.summary["entries_new"], 2)
        self.assertEqual(first.summary["entries_unchanged"], 0)
        self.assertEqual(first.summary["acquisition_requests"], 2)
        self.assertEqual(first.summary["duplicates"], 0)
        ...
        self.assertEqual(second.summary["duplicates"], 0)
        ...
        self.assertEqual(updated.summary["entries_unchanged"], 1)
        self.assertEqual(updated.summary["acquisition_requests"], 1)
        self.assertEqual(updated.summary["artifacts_retained"], 1)
        self.assertEqual(updated.summary["duplicates"], 1)
...
class Task067CliApiCase(unittest.TestCase):
    ...
    def test_admin_page_api_history_and_rss_endpoint(self) -> None:
        ...
        try:
            ...
            self.assertIn("New / updated", html)
            self.assertIn("Unchanged", html)
            self.assertIn("acquisition requests", html)
            self.assertIn("Unchanged feed entries are not counted as duplicates", html)
