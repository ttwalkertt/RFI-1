    ...
    def test_product_scope_matches_completed_architectural_milestones(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                "investigation_qa/__init__.py",
                "investigation_qa/contracts.py",
                "investigation_qa/orchestration.py",
                "investigation_qa/prompts.py",
                ...
                "pull/workflow.py",
                "py.typed",
                "qa_gauge/__init__.py",
                "qa_gauge/benchmark.py",
                "qa_gauge/contracts.py",
                "qa_gauge/prompts.py",
                "qa_gauge/scoring.py",
