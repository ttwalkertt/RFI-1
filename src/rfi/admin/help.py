...
HELP_TOPICS = (
    ...
    HelpTopic("feeds", "Repository-owned feeds"),
    HelpTopic("linux-mailing-lists", "Linux Mailing Lists"),
    HelpTopic("choosing-lore", "Choosing a Lore mailing list"),
    HelpTopic("bounded-mailing-list-acquisition", "Bounded mailing-list acquisition"),
    HelpTopic("discussion-context", "Direct matches and discussion context"),
    HelpTopic("generated-identities", "Generated mailing-list identities"),
    HelpTopic("mailing-list-lifecycle", "Mailing-list validation, creation, and testing"),
    HelpTopic("incomplete-mailing-list-results", "Incomplete mailing-list results"),
    HelpTopic("mailing-list-retry", "Rerunning a mailing-list stream"),
    HelpTopic("lore-connectivity", "Troubleshooting Lore connectivity"),
